/**
 * Standalone Supabase to Better Auth Migration Script
 *
 * Environment Variables
 * - FROM_DATABASE_URL: Supabase database connection string
 * - TO_DATABASE_URL: Better Auth database connection string
 *
 * Your Better Auth instance must have:
 * - emailAndPassword.enabled = true
 * - admin, anonymous, phoneNumber plugins enabled
 * - user.additionalFields with userMetadata, appMetadata, invitedAt, lastSignInAt
 */
...
async function main() {
  console.log('🚀 Supabase → Better Auth Migration\n');
